const styles = {
  ...
  heroHeading2:
    'font-bold lg:text-[60px] md:text-[44px] sm:text-[20px] text-[16px] lg:leading-[158.4px] md:leading-[114.4px] sm:leading-[74.4px] leading-[64.4px] uppercase text-white',
  heroDText:
